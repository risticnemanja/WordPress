...
// Funkcija za dodavanje imena autora

add_action('woocommerce_after_add_to_cart_form','dodaj_ime_autora');

function dodaj_ime_autora(){
...
{
     if ($related_text === 'Product' && is_page(58)) {
